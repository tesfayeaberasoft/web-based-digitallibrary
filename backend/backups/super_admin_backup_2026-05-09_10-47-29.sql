...
CREATE TABLE `book_branch_inventory` (
  ...
  CONSTRAINT `book_branch_inventory_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE,
  CONSTRAINT `book_branch_inventory_ibfk_2` FOREIGN KEY (`branch_id`) REFERENCES `library_branches` (`id`) ON DELETE CASCADE
...
CREATE TABLE `book_reservations` (
  ...
  KEY `idx_book_reservation` (`book_id`),
  KEY `idx_status` (`status`),
  KEY `idx_queue` (`queue_position`),
  CONSTRAINT `book_reservations_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `book_reservations_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `book_reviews` (
  ...
  KEY `idx_book_review` (`book_id`),
  KEY `idx_rating` (`rating`),
  CONSTRAINT `book_reviews_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `book_reviews_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`) ON DELETE CASCADE
...
INSERT INTO `books` VALUES ('5', '978-0-7432-4722-4', 'The Catcher in the Rye', 'J.D. Salinger', 'Little, Brown', '1951', '1', 'A controversial novel about teenage rebellion', NULL, '3', '1', '277', 'English', NULL, 'physical', '16.99', 'active', 'good', '2026-05-05 01:13:37', '2026-05-07 06:19:10');
...
INSERT INTO `books` VALUES ('8', '978-0-06-112009-1', 'The Hobbit', 'J.R.R. Tolkien', 'Houghton Mifflin', '1937', '1', 'A fantasy adventure novel', NULL, '7', '5', '310', 'English', NULL, 'physical', '14.99', 'active', 'good', '2026-05-05 01:13:37', '2026-05-07 01:22:28');
INSERT INTO `books` VALUES ('12', '978-1234567890', 'Sample Book Title', 'John Doe', 'Sample Publisher', '2024', '1', 'A sample book description', NULL, '5', '5', '200', 'English', NULL, 'physical', '0.00', 'active', 'poor', '2026-05-07 05:07:23', '2026-05-07 05:32:21');
INSERT INTO `books` VALUES ('13', '978-0987654321', 'Another Book', 'Jane Smith', 'Another Publisher', '2023', '2', 'Another book description', NULL, '3', '3', '150', 'English', NULL, 'physical', '0.00', 'active', 'good', '2026-05-07 05:07:23', '2026-05-07 05:07:23');
...
CREATE TABLE `library_branches` (
  ...
  CONSTRAINT `library_branches_ibfk_1` FOREIGN KEY (`manager_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
...
CREATE TABLE `notification_settings` (
  ...
  `due_reminder_days` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '[3, 1]' CHECK (json_valid(`due_reminder_days`)),
  `overdue_reminder_days` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '[1, 3, 7]' CHECK (json_valid(`overdue_reminder_days`)),
  `reservation_notifications` tinyint(1) DEFAULT 1,
  `fine_notifications` tinyint(1) DEFAULT 1,
...
INSERT INTO `notifications` VALUES ('73', '5', 'general', 'Account Suspended', 'Your account has been suspended. Please contact the library for more information.', 'unread', NULL, NULL, '2026-05-08 16:55:00', NULL);
INSERT INTO `notifications` VALUES ('74', '5', 'general', 'Account Activated', 'Your account has been reactivated. You can now access all library services.', 'unread', NULL, NULL, '2026-05-08 16:55:04', NULL);
...
CREATE TABLE `payment_transactions` (
  ...
  `payment_method` varchar(50) DEFAULT NULL,
  `chapa_transaction_id` varchar(100) DEFAULT NULL,
...
CREATE TABLE `reading_goals` (
  ...
  KEY `idx_status` (`status`),
  CONSTRAINT `reading_goals_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
...
INSERT INTO `system_settings` VALUES ('1', 'library', 'library_name', 'Digital Library Management System', 'Name of the library', '2026-05-09 10:22:40', NULL);
INSERT INTO `system_settings` VALUES ('5', 'library_policies', 'reservation_expiry_days', '3', 'Number of days a reservation remains valid', '2026-05-09 09:28:54', NULL);
INSERT INTO `system_settings` VALUES ('6', 'system', 'max_renewal_count', '2', 'Maximum number of times a book can be renewed', '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('7', 'system', 'notification_email', 'library@example.com', 'Email address for system notifications', '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('8', 'system', 'chapa_public_key', 'CHAPA_PUBLIC_KEY_HERE', 'Chapa payment gateway public key', '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('9', 'system', 'chapa_secret_key', 'CHAPA_SECRET_KEY_HERE', 'Chapa payment gateway secret key', '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('10', 'system', 'google_books_api_key', 'GOOGLE_BOOKS_API_KEY_HERE', 'Google Books API key for metadata', '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('11', 'system', 'sendgrid_api_key', 'SENDGRID_API_KEY_HERE', 'SendGrid API key for email notifications', '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('12', 'library_policies', 'max_user_borrow_books', '6', 'Maximum books a user can borrow simultaneously', '2026-05-09 10:22:41', NULL);
INSERT INTO `system_settings` VALUES ('13', 'library_policies', 'due_fines_per_day', '0.6', 'Daily fine amount for overdue books (USD)', '2026-05-09 10:22:41', NULL);
INSERT INTO `system_settings` VALUES ('14', 'library_policies', 'max_book_return_days', '28', 'Maximum days allowed for book return', '2026-05-09 10:22:41', NULL);
INSERT INTO `system_settings` VALUES ('16', 'library', 'description', 'A comprehensive digital library management solution', NULL, '2026-05-09 10:22:40', NULL);
INSERT INTO `system_settings` VALUES ('17', 'library', 'address', '123 Library Street, Education City', NULL, '2026-05-09 10:22:40', NULL);
INSERT INTO `system_settings` VALUES ('18', 'library', 'phone', '+1 (555) 123-4567', NULL, '2026-05-09 10:22:40', NULL);
INSERT INTO `system_settings` VALUES ('19', 'library', 'email', 'iinfo@digitallibrary.com', NULL, '2026-05-09 10:22:40', NULL);
INSERT INTO `system_settings` VALUES ('20', 'library', 'website', 'https://digitallibrary.com', NULL, '2026-05-09 10:22:40', NULL);
INSERT INTO `system_settings` VALUES ('24', 'library', 'operatingHours', '{\"monday\":{\"open\":\"08:00\",\"close\":\"20:00\",\"closed\":false},\"tuesday\":{\"open\":\"08:00\",\"close\":\"20:00\",\"closed\":true},\"wednesday\":{\"open\":\"08:00\",\"close\":\"20:00\",\"closed\":false},\"thursday\":{\"open\":\"08:00\",\"close\":\"20:00\",\"closed\":false},\"friday\":{\"open\":\"08:00\",\"close\":\"18:00\",\"closed\":false},\"saturday\":{\"open\":\"09:00\",\"close\":\"17:00\",\"closed\":false},\"sunday\":{\"open\":\"10:00\",\"close\":\"16:00\",\"closed\":false}}', NULL, '2026-05-09 10:22:40', NULL);
INSERT INTO `system_settings` VALUES ('25', 'library', 'socialMedia', '{\"facebook\":\"https:\\/\\/facebook.com\\/digitallibrary\",\"twitter\":\"https:\\/\\/twitter.com\\/digitallibrary\",\"instagram\":\"https:\\/\\/instagram.com\\/digitallibrary\",\"linkedin\":\"https:\\/\\/linkedin.com\\/company\\/digitallibrary\"}', NULL, '2026-05-09 10:22:40', NULL);
INSERT INTO `system_settings` VALUES ('93', 'library', 'libraryName', 'Digital Library Management System', NULL, '2026-05-09 10:22:40', NULL);
INSERT INTO `system_settings` VALUES ('141', 'system', 'maxBorrowDays', '30', NULL, '2026-05-09 10:29:43', NULL);
INSERT INTO `system_settings` VALUES ('142', 'system', 'finePerDay', '0.8', NULL, '2026-05-09 10:29:43', NULL);
INSERT INTO `system_settings` VALUES ('143', 'system', 'maxBooksPerUser', '9', NULL, '2026-05-09 10:29:43', NULL);
INSERT INTO `system_settings` VALUES ('144', 'system', 'maxReservationsPerUser', '4', NULL, '2026-05-09 10:29:43', NULL);
INSERT INTO `system_settings` VALUES ('145', 'system', 'reservationHoldDays', '8', NULL, '2026-05-09 10:29:43', NULL);
INSERT INTO `system_settings` VALUES ('146', 'system', 'renewalLimit', '2', NULL, '2026-05-09 10:29:43', NULL);
INSERT INTO `system_settings` VALUES ('147', 'system', 'gracePeriodDays', '3', NULL, '2026-05-09 10:29:43', NULL);
INSERT INTO `system_settings` VALUES ('148', 'system', 'autoRenewal', '1', NULL, '2026-05-09 10:29:43', NULL);
INSERT INTO `system_settings` VALUES ('149', 'system', 'emailNotifications', '1', NULL, '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('150', 'system', 'smsNotifications', '1', NULL, '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('151', 'system', 'overdueNotificationDays', '[1,3,7]', NULL, '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('152', 'system', 'maintenanceMode', '1', NULL, '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('153', 'system', 'allowRegistration', '1', NULL, '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('154', 'system', 'requireEmailVerification', '1', NULL, '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('155', 'system', 'sessionTimeout', '60', NULL, '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('156', 'system', 'passwordMinLength', '8', NULL, '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('157', 'system', 'passwordRequireSpecial', '', NULL, '2026-05-09 10:29:44', NULL);
INSERT INTO `system_settings` VALUES ('158', 'system', 'twoFactorAuth', '1', NULL, '2026-05-09 10:29:44', NULL);
...
INSERT INTO `users` VALUES ('4', 'LIB003', 'LIB0004', 'Emily Davis', 'emily@library.com', '+1-555-0103', '789 Reading Rd, City, State', 'General', '2026-05-08', 'morning', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'librarian', 'active', NULL, 'Demoted from librarian: okkkkkkkkkkkkkkkkk', NULL, '2026-05-05 01:13:37', '2026-05-08 20:01:54', NULL, NULL);
INSERT INTO `users` VALUES ('5', 'USR001', NULL, 'John Doe', 'john.doe@example.com', '+251911234567', '444444444444444444444', NULL, NULL, 'morning', '$2y$10$n4jDK3wkXkzZDneB13Wnw.MGEaq.NfynKwbnMDaaZvkxCbdw3afEq', 'user', 'active', NULL, NULL, 'uploads/profile_images/user_5_1778074616.PNG', '2026-05-05 01:13:37', '2026-05-08 16:55:04', '2026-05-08 15:35:50', NULL);
...
INSERT INTO `users` VALUES ('17', 'USER001', 'LIB0017', 'tesfaye abera (Updated)', 'asssok@co.com', '111111111111111111', '123errr', 'General', '2026-05-08', 'morning', '$2y$10$jHqAlH9lSEvUxQCeGm4UlelgkmbOOeveH8ZqLXojt/XF.KtcvFp2u', 'librarian', 'active', NULL, NULL, NULL, '2026-05-08 16:41:25', '2026-05-08 18:37:45', NULL, NULL);
...
INSERT INTO `users` VALUES ('24', 'SUPER001', NULL, 'Super Administrator', 'superadmin@digitallibrary.com', NULL, NULL, NULL, NULL, 'morning', '$2y$10$M2xc36LOUfjdIYOql9q9HOlXVtntA7cBP/w47cDtAcsqKuXjLRAZK', 'super-admin', 'active', NULL, NULL, NULL, '2026-05-09 12:28:24', '2026-05-09 11:46:52', '2026-05-09 11:46:52', NULL);
